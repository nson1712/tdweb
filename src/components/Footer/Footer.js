          ...
          <div className="">
            <div className="flex gap-x-2">
              ...
              <div className="space-y-2 self-center">
                ...
                Toidoc là nền tảng #1 dành cho phái nữ với nhiều đánh giá chất lượng từ độc giả. Độc giả có thể lựa chọn đa dạng các thể loại truyện full, truyện hot, truyện đề cử khác nhau như #điền văn, #ngôn tình hiện đại, #đam mỹ, #sủng, #ngược, #zhihu, .... Web truyện luôn cập nhật những bộ truyện mới nhất một cách nhanh nhất.
                </div>
                <div className="text-xs text-slate-500">Tất cả người dùng được yêu cầu tuân thủ nghiêm ngặt luật pháp và quy định quốc gia có liên quan khi xuất bản nội dung. Chúng tôi từ chối mọi nội dung không hợp thuần phong mỹ tục, bạo lực, bất hợp pháp khác và sẽ hủy chúng ngay khi phát hiện.
                ...
                Các tác phẩm, bình luận, nội dung hoặc hình ảnh đều do thành viên đăng tải. Nếu làm ảnh hưởng đến cá nhân hay tổ chức nào, khi được yêu cầu, chúng tôi sẽ xác minh và gỡ bỏ ngay lập tức.
                </div>
              </div>
      ...
      <div className="bg-black w-full py-2">
        <div className="max-w-[1116px] md:flex justify-between mx-auto px-1 space-y-2">
          <div className="order-2 flex justify-center text-sm md:text-base font-medium text-gray-500 dark:text-gray-400 sm:mt-0 gap-x-2 sm:py-2">
            <div>
              <a href="/tim-kiem" title="Trang chủ" className="text-white text-underline text-md">
                Trang chủ
              </a>
            </div>
            <div><p>|</p></div>
            ...
            <div><p>|</p></div>
            <div>
              <a href="https://docgia-guide.toidoc.vn/" className="text-white text-underline text-md" title="Câu hỏi thường gặp khi sử dụng Toidoc">
                Câu hỏi thường gặp
              </a>
            </div>
          </div>
