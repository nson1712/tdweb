            ...
            children: (
              <div className="space-y-2">
                ...
                <div className="text-base">
                  <span className="font-bold">Cách 1:</span> Chọn gói kim cương
                  bạn muốn nạp, mã QR tương ứng sẽ hiện ra để bạn chuyển khoản
                </div>

                <p className="text-base font-medium">
                  <p>
                    <span className="font-bold">Cách 2:</span> Chuyển khoản trực
                    tiếp vào tài khoản sau:
                  </p>
