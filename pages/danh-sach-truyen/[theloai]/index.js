...
Stories.getInitialProps = async (ctx) => {
  try {
    ...
    if (ctx.query.theloai === 'trending') {
      detail = {
        title : 'Danh sách truyện mới nổi hấp dẫn | Nền tảng cộng đồng đọc truyện online Toidoc',
        description : 'Danh sách những truyện mới nổi được nhiều độc giả quan tâm và đọc nhiều trên nền tảng Toidoc. Danh sách truyện được được đề xuất bởi độc giả Toidoc bạn không nên bỏ qua.',
    ...
    if (ctx.query.theloai === 'moi-nhat') {
      detail = {
        title :  'Danh sách truyện chữ mới nhất | Nền tảng cộng đồng đọc truyện online Toidoc',
        description : 'Danh sách những truyện mới vừa được cập nhật, nóng hổi vừa thổi vừa ăn tại Toidoc. Truyện được đăng bởi các tác giả và dịch giả uy tín trên Toidoc với nhiều thể loại truyện khác nhau.',
    ...
    if (ctx.query.theloai === 'truyen-full') {
      detail = {
        title :  'Danh sách truyện đã hoàn cuốn hút | Nền tảng cộng đồng đọc truyện online Toidoc',
    ...
    if (ctx.query.theloai === 'xem-nhieu-nhat') {
      detail = {
        title :  'Tuyển tập bộ truyện chữ được xem nhiều | Nền tảng cộng đồng đọc truyện online Toidoc',
    ...
    if (ctx.query.theloai === 'hot') {
      detail = {
        title : 'Danh sách những bộ truyện HOT | Nền tảng cộng đồng đọc truyện online Toidoc',
        description : 'Danh sách những bộ truyện HOT không thể bỏ qua. Danh sách này là những bộ truyện mới HOT trong thời gian gần đây do độc giả Toidoc đề cử',
