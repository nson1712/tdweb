  ...
  const getDetail = async () => {
    try {
      if (ctx.query.storySlug !== 'images' && ctx.query.storySlug !== 'img') {
        ...
        typeof window !== 'undefined' ? `https://uatapi.truyenso1.xyz/data/private/data/story/detail?slug=${ctx.query.storySlug}` : `http://10.8.22.203:8081/private/data/story/detail?slug=${ctx.query.storySlug}`)
